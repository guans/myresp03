...
public interface MessageITProtocolConstants {
	public static final String MSGIT_CLIENT="CLIENT";
	public static final String MSGIT_SUBSCRIBE="SUBSCRIBE";
	public static final String MSGIT_UNSUBSCRIBE="UNSUBSCRIBE";
	public static final String MSGIT_END="END";
}
